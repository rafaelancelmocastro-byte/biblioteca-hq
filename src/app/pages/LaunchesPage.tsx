...
export function LaunchesPage({ onOpenReader }: { onOpenReader: (id: string) => void }) {
  ...
  return <div className="streaming-page space-y-8"><header className="page-spotlight"><span className="page-kicker"><Sparkles /> 2026 EDITION</span><h1>Lançamentos 2026</h1><p>As edições deste ano aparecem aqui automaticamente quando entram no catálogo.</p></header>
